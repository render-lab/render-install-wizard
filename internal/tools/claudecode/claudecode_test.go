...
// overrides (e.g. a CI runner's CLAUDE_CONFIG_DIR) so path resolution stays under
// the injected temp home. Tests that exercise an override set it via t.Setenv.
